...
declare interface AcolyteFightMod {
  Mod: ModSettings;
...
declare interface StrikeCancelParams
  extends SpellCancelParams, ColliderTemplate {
}
...
declare interface RenderProjectile
  extends RenderParamsBase, ProjectileColorParams {
  type: "projectile";
...
declare interface RenderPolygon
  extends RenderParamsBase, ProjectileColorParams {
  type: "polygon";
...
declare interface RenderStrike
  extends RenderParamsBase, ProjectileColorParams, RenderStrikeParams {
  type: "strike";
  ticks: number;
